...
from StatusIndicator import StatusLED
from VisionCanvas import VisionCanvas
from HyLink import HyLink
from PlatformUtil import WinUtil
from RecipeTree import RecipeManager, BaseUITool
...
class InspectorApp(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.vision_map = VisionCanvas(self.recipe_manager)
